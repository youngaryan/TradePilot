...
export default function App() {
  ...
  const cockpitStats = [
    {
      label: "Paper equity",
      value: payload ? formatCurrency(payload.totals?.equity ?? 0) : "Not loaded",
      ...
      <main className="app-main">
        <section className="app-hero">
          ...
          <aside className="hero-product-card">
            ...
            <strong>{payload?.totals?.equity != null ? formatCurrency(payload.totals.equity) : "No paper ledger yet"}</strong>
        ...
        >
          ...
          {activeView === "backtests" ? (
            <BacktestLab
              ...
              strategyBuilderMode={workspace?.capabilities.strategy_builder_mode ?? "rules"}
            />
          ) : null}
