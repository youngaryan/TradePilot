...
import { formatDateTime, formatNumber, formatPercent, jobDisplayStatus, splitList, splitSymbols, statusTone, toNumber } from "../utils/format";
      ...
      <div className={`job-progress-card ${activeJob?.status === "completed" ? "job-progress-card--done" : ""} ${activeJob?.status === "completed" && jobHasWarnings ? "job-progress-card--warning" : ""} ${activeJob?.status === "failed" || activeJob?.status === "interrupted" ? "job-progress-card--failed" : ""}`}>
        <div className="progress-card__top">
          ...
          <div className="badge-row">
            <Badge label={activeJob?.status === "completed" && jobHasWarnings ? "warnings" : jobDisplayStatus(activeJob)} tone={activeJob?.status === "completed" && jobHasWarnings ? "warn" : statusTone(jobDisplayStatus(activeJob))} />
