...
import { ArrowRight, BrainCircuit, CheckCircle2, FlaskConical, Newspaper, Rocket, ShieldCheck, Sparkles, Sun } from "lucide-react";
...
const landingFaqs = [
  ...
  { question: "Is this real trading?", answer: "No. Apollo is fake-money paper trading only. There is no broker connection, no real orders, and no cash movement." }
];
const workflowSteps = [
...
const legalPages: Record<string, { title: string; body: string[] }> = {
  "/privacy": {
    ...
    body: [
      "Apollo stores account, workspace, telemetry, and research metadata needed to operate the product. Telemetry is minimized, consent-aware, and redacts sensitive fields such as passwords, API keys, emails, and tokens.",
  ...
  "/terms": {
    title: "Terms of Use",
    body: [
      "Apollo is a research and paper-trading tool. You are responsible for your data sources, strategy decisions, and compliance obligations.",
  ...
  "/risk-disclaimer": {
    ...
    body: [
      "Nothing in Apollo is financial advice. Backtests, sentiment scores, and fake-money paper results are educational and may not predict live trading outcomes.",
  ...
  "/compliance": {
    ...
    body: [
      "Apollo is limited to research workflows and fake-money paper trading. The product should not be marketed as investment advice, guaranteed performance, signal recommendations, or automated real-money trading.",
...
export function LoginScreen({ onLogin }: { onLogin: (auth: AuthResponse) => void }) {
    ...
    return (
      <div className="marketing-shell">
        <header className="marketing-nav">
          <a className="marketing-brand" href="/" aria-label="Apollo home"><Sun size={24} /><span>Apollo</span></a>
  ...
  if (legalPage) {
    return (
      <div className="marketing-shell">
        <header className="marketing-nav">
          <a className="marketing-brand" href="/" aria-label="Apollo home">
            <Sun size={24} />
            <span>Apollo</span>
          </a>
        ...
        <main className="legal-page">
          <span className="hero-kicker">Apollo policy</span>
          <h1>{legalPage.title}</h1>
          {legalPage.body.map((paragraph) => <p key={paragraph}>{paragraph}</p>)}
          <a className="primary-button" href="/">Back to Apollo</a>
        </main>
      </div>
    );
  }
  ...
  return (
    <div className="marketing-shell">
      <header className="marketing-nav">
        <a className="marketing-brand" href="#top" aria-label="Apollo home">
          <Sun size={24} />
          <span>Apollo</span>
        </a>
      ...
      <main id="top">
        <section className="marketing-hero">
          <div className="hero-copy">
            ...
            <p>
              Apollo helps you move from idea to audited fake-money deployment with backtests, sentiment data,
      ...
      <footer className="marketing-footer">
        <span>Apollo research cockpit</span>
