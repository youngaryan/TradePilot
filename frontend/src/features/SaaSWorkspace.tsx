    ...
    <div className="saas-workspace">
      ...
      {section === "billing" ? (
        <div className="grid-two">
          ...
          <Panel title="SaaS readiness notes" subtitle="Production controls are available and still require operator verification.">
            <Explainer
              icon={<DatabaseZap size={17} />}
              title="What is production vs prototype?"
              body="The production topology includes external workers, Postgres/object storage, Stripe webhooks, explicit secret resolution, and observability. Operators must configure and verify those controls. TradePilot remains paper-only, and legal review is required before any live-money use."
            />
          </Panel>
        </div>
      ) : null}
